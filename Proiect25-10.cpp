...
int main()
{
	...
	pacient.diagnostic = (char*)malloc(100);

	strcpy_s(pacient.nume, "John");
	pacient.varsta = 35;
	pacient.greutate = 75;
	strcpy_s(pacient.diagnostic, "Ebolla");
	...
	Student s_test;
	//Sa se testeze toate atributele cu =
	...
	s_test.id = 13
	strcpy_s(s_test.nume, "-");
	strcpy_s(s_test.prenume, "-");
